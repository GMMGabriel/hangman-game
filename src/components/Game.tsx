...
export function Game(props: GameProps) {
  ...
  // function playAgain(to: string, e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) {
  //   // e.preventDefault()
        ...
        {!finished ? (
          <>
            ...
            <div className="actions">
              <a href="/singleplayer" className="button spacing" onClick={(event) => { goBack("/singleplayer", event) }}>Menu</a>
            </div>
          </>
        ) : (
          <>
